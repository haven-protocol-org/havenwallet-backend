...
CurrentBlockchainStatus::get_rct_output_distribution(
        std::vector<uint64_t>& rct_offsets, uint64_t& start_height, std::string asset_type) const
{

    if (!rpc->get_rct_output_distribution(rct_offsets, start_height, asset_type))
    {
